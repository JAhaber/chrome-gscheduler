    ...
    return (
      ...
      <h1>GScheduler Version: 0.5.0 Changelog:</h1>
        ...
        <ul>
          ...
          <li>A new save button for each individual day has been added for any tasks that have not been saved after their date has passed</li>
          ...
          <p>Drag and Drop Into GScheduler</p>
          <li>Updated drag and drop functionality to allow dropping tasks in to GScheduler</li>
          <li>Dropped tasks can take the following forms:
            <ul>
              <li><strong>A Task ID:</strong> XXXXXXX</li>
              <li><strong>A Task ID with a hashtag:</strong> #XXXXXXX</li>
              <li><strong>A Task URL:</strong> https://genome.klick.com/tickets/#/details/XXXXXXX</li>
              <li><strong>A Google Redirect to a Task URL</strong> (generated by dragging from Hangouts chat): https://www.google.com/url?q=https://genome.klick.com/tickets/#/details/XXXXXXX</li>
            </ul>
          </li>
